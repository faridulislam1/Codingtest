                ...
                <div class="row">
                    <div class="col-lg-3 col-md-4 col-12">
                        <div class="footer-logo">
                            <a href="index.html">
                                <img src="{{asset('/')}}website/assets/images/logo/logo.png" alt="#">
                            </a>
                        </div>
                    </div>
        ...
        <div class="container">
            <div class="inner-content">
                <div class="row align-items-center">
                    ...
                    <div class="col-lg-4 col-12">
                        <div class="copyright">
                            <p>Designed and Developed by<a href="https://graygrids.com/" rel="nofollow" target="_blank">Faridul Islam</a></p>
                        </div>
                    </div>
                    <div class="col-lg-4 col-12">
                        <ul class="socila">
