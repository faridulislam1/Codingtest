            ...
            <div class="cart-list-head">
                ...
                <div class="cart-single-list">
                    <div class="row align-items-center">
                        ...
                        <div class="col-lg-2 col-md-2 col-12">
                            <div class="">{{$cart_product->price}}</div>
                        </div>
                        <div class="col-lg-2 col-md-2 col-12">
                        ...
                        <div class="col-lg-1 col-md-2 col-12">
                            <a class="remove-item"  onclick= " return confirm('Are You sure delete this.')" href="{{route('remove-cart-product',['id'=>$cart_product->__raw_id])}}"><i class="lni lni-close"></i></a>
                        </div>
                    </div>
                </div>
